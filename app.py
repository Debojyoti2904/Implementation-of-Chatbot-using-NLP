...
file_path = os.path.abspath("./convo.json")
...
def chatbot(input_text):
    ...
    for items in contents:
        if items['tag'] == tag:
            response = random.choice(items['responses'])
            return response
...
def main():
    ...
    # Home Menu
    if choice == "Home":
        st.write("Welcome to the chatbot. Feel free to ask anything. Always at your service")
        ...
        if user_input:
            ...
            # Save the user input and chatbot response to the chat_history.csv file
    ...
    # Conversation History Menu
        ...
        - Intents: The intent of the user input (e.g. "greeting", "basic conversations", "about")
        - Entities: The entities extracted from user input (e.g. "Hi", "Tell me a joke", "What is your purpose?")
